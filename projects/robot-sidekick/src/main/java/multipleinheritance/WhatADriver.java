...
public class WhatADriver extends Robot{
    ...
    public void setChoice() {
        ...
        System.out.println("***** WhatADriver Menu *****");
    ...
    public void takeAction() {
        ...
        switch (getModeOfOperation()) {
            case 1:
                driveACar();
                System.out.println("WhatADriver has completed the drive.");
                break;
            case 2:
                flyAPlane();
                System.out.println("WhatADriver has completed the flight.");
                break;
            case 3:
                rechargeBattery();
                System.out.println("WhatADriver has recharged battery.");
                break;
            case 4:
                System.out.println("WhatADriver Battery:");
                displayBatteryLevel();
                break;
            default:
                System.out.println("WhatADriver does not support the operation.");
        }
    }
