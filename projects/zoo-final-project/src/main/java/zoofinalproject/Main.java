...
public class Main {
    public static void main(String[] args) {
        ...
        // for loop continuation - 1 represents true / 2 represents false
        int continueOuterLoop = 1;
        int continueInnerLoop = 1;

        // for menu choice - 1 represents true / 2 represents false
        int menuChoice = 1;
            ...
            switch (animalChoiceMenu(keyboard)) {
                case 1:
                    do {
                        ...
                        switch (menuChoice) {
                            case 1:
                                System.out.println("Enter speed of " + tigerObject.getNameOfAnimal() + ":");
                                tigerObject.setSpeed(keyboard.nextInt());

                                System.out.println("Enter number of stripes of " + tigerObject.getNameOfAnimal() + ":");
                                tigerObject.setNumberOfStripes(keyboard.nextInt());

                                System.out.println("Enter sound level of roar of " + tigerObject.getNameOfAnimal() + ":");
                ...
                case 2:
                    do {
                        ...
                        switch (menuChoice) {
                            case 1:
                                System.out.println("Enter color of " + dolphinObject.getNameOfAnimal() + ":");
                                dolphinObject.setColor(keyboard.next());

                                System.out.println("Enter swimming speed of " + dolphinObject.getNameOfAnimal() + ":");
                        ...
                        switch (menuChoice) {
                            case 1:
                                ...
                                if (penguinObject.isSwimming()) {
                                    ...
                                    System.out.println("Enter de walking speed of " + penguinObject.getNameOfAnimal() + ":");
        ...
        System.out.println("Thank you for using our Zoo.");
    }
