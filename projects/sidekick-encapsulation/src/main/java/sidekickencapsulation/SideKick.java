...
public class SideKick {
    ...
    public void setChoice() {
        System.out.println("***** sidekickencapsulation.SideKick Menu *****");
    ...
    public void takeAction() {
        switch (modeOfOperation) {
            case 1:
                cleanHouse();
                System.out.println("sidekickencapsulation.SideKick cleaning completed.");
                break;
            case 2:
                /** TODO 14: call the method cookFood() you created in TODO 13  **/
                System.out.println("sidekickencapsulation.SideKick cooking completed.");
                break;
            case 3:
                rechargeBattery();
                System.out.println("sidekickencapsulation.SideKick recharged battery.");
                break;
            default:
                System.out.println("sidekickencapsulation.SideKick does not support the operation.");
        }
    }
    ...
    // method to cook
    /** TODO 13: Create a method to display the tasks sidekickencapsulation.SideKick does
